...
interface ItemClassDao {
    ...
    @SqlQuery("SELECT name, description, unit FROM Item_classes ORDER BY name")
    ...
    fun selectAttributesWithTypesForItemClass(itemClassName: String): List<AttributeWithTypeRec>
    ...
    fun selectAttributeValuesForItemClass(itemClassName: String): List<AttributeTypeValueRec>
}
